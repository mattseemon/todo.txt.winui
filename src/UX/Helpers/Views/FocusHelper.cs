...
{
    public static readonly DependencyProperty IsFocusedProperty = DependencyProperty.Register("IsFocused", typeof(bool), typeof(FocusHelper), new PropertyMetadata(false, new PropertyChangedCallback(OnIsFocusedPropertyChanged)));
